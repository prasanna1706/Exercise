...
<script>globalURL = 'https://tryit.w3schools.com/code_datas.php';getSavedFile()</script>
  ...
  <div class="w3-modal-content">
    <div class="w3-display-container">
      ...
      <div id="driveText" class="w3-panel w3-large">
        ...
        <input class="w3-input w3-border" type="text" id="googleFileName" value="">
